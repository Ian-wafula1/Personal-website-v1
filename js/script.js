...
// Used `defer` instead of `DOMContendLoaded` event
// Select elements for card images and drop down menu
const imgs = [...document.querySelectorAll(".card > div")];
...
// Adds a hover animation to the card images
imgs.forEach((img) =>
...
// Hides and displays the header in smaller viewports
